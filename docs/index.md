...
本提言案は、「デジタル民主主義2030」プロジェクトの一環であり、「**[いどばた政策共創ツール(仮名称)](https://delib.takahiroanno.com/view/docs)**」を使って、どなたでも修正提案が可能です。皆様からのご意見を反映し、東京都の「東京都AI戦略会議」へ提言を行う予定です。
...
これまでの民主主義では、投票による多数決の仕組みよりも詳細な市民の意見を、政策に反映するのが非常に難しいという課題がありました。一方、情報技術やAIの発展により、昨今は、多くの人の意見を質的に整理し、多数決よりも建設的な形で、議論・合意形成することが実現しやすくなっています。
私たちは民意による政策反映を可能にする大規模熟議プラットフォームを構築し、政党や自治体などに提供することで、デジタル民主主義をさらに推し進めたいと考えています。

本提言では、「[デジタル民主主義2030](https://dd2030.org/)」で構築した、デジタル上で大規模熟議が可能なプラットフォーム「いどばた」を活用し、皆さまの意見を踏まえた提言を作成しています。
