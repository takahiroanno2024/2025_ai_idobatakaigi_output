...
- **学習データがブラックボックスである限り、AI出力の中立性・公平性を根本から検証することは不可能であり、著作権侵害やプライバシー問題といった重大なリスクが内在している疑いを払拭できない。**
...
- 「プロンプトを公開して市民にチェックしてもららうことも一手。プロンプトは情報公開条例にいう行政文書にあたると考えられる」 – *[Takatsugu_Imaizumi](https://large-scale-conversation-sandbox.discourse.group/t/topic/74/28?u=eitaro)*
