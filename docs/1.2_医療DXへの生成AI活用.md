...
## 施策3：医薬品・医療機器メーカーの品質管理DX/AI活用支援

### 何をするかの概要
都内の中小医薬品・医療機器メーカーの品質管理DX/AI導入を支援し、業務効率化と製品品質向上、新たなソリューション創出を促す。

### 具体内容
- 高価な品質管理ソフトウェア導入に対する補助金制度の創設。
- 品質管理DXソリューションを提供する企業への開発支援。

### その提案が良い理由
- 中小メーカーのコスト障壁を低減しDX化を推進。
- 品質管理の効率化（人件費削減）と製品品質向上。
- 都内メーカーの競争力強化とイノベーション促進。

### インパクト
- 品質管理業務における**人件費を半減**させる可能性。
- 品質不良率を**半減**させ、製品品質を向上。
- 上記を通じ、メーカーの**製品開発力向上**に寄与。
- 都内関連産業の活性化と**競争力強化**。
