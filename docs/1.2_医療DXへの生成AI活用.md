...
2. **施策2：都民向け24時間AI健康相談チャットボットの導入**  
   既存の電話相談窓口（#7119等）の負荷を軽減し、夜間・休日を含めた適切な医療行動を都民が取れるよう支援する。オンライン診療等との連携も視野に入れる。
...
都民がスマホやPCで気軽に健康相談できるチャットボットを提供し、症状からの緊急度判定や対応アドバイスを自動化。既存電話相談（#7119等）を補完。**なお、導入前に現行の#7119、#8000の効果測定（軽症患者の流入抑制効果等）を地域病院と連携して実施し、課題を明確化することが望ましい。**
...
- **症状や緊急度に応じ、オンライン診療や夜間・休日処方薬受け取りサービスへのスムーズな連携機能（検討課題）**
...
- 特に若年層に対する心理的ハードルが低い
- **オンライン診療や処方薬受け取りとの連携により、相談から実際の処置まで一貫してサポートできれば、都民の利便性向上と不要な救急受診抑制により効果的に繋がる可能性がある**
...
| **オンライン診療連携時の誤診リスク** | **対面診療原則の遵守、連携先医療機関との責任分担明確化、遠隔処方ガイドライン準拠** |
| **処方薬の受け渡し体制の不備**   | **地域薬局との連携強化、夜間・休日対応可能な薬局ネットワーク構築、配送システム検討** |
