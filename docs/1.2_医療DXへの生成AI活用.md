...
1. **施策1：医用画像診断AIの都立病院全体への導入**  
   放射線診断医不足に対応し、AIによる画像診断支援を活用することで診断精度向上・**見落としリスク低減を通じた**早期治療を促進する。
...
都立病院に対し、X線・CT・MRIなどの医用画像をAIが解析・診断補助するシステムを導入。誤診リスクを低減し、放射線科医の**診断を支援**。
...
- AIによるダブルチェックは、**見落としリスク低減や診断精度向上に貢献**し、**患者アウトカムの改善**にもつながる。
