...
AIのような強力な技術を活用する際は、その前提として「何を目指すのか」という目的や方針を明確に定めることが極めて重要です。例えば教育分野でのAI活用を考える際も、まずどのような教育を実現したいのか、そのビジョンをしっかりと議論する必要があります。

現時点での政策提言案はこちらから確認できます。

- 1.生成AI活用
    - [1.1 教育DXへの生成AI活用](./1.1_教育DXへの生成AI活用.md)（AIによる個別学習支援に加え、全国の子ども達を繋ぐリモート交流での社会性育成も視野に入れる）
